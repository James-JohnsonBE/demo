...
$(document).ready(function () {
    SP.SOD.executeFunc('sp.js', 'SP.ClientContext', ExecuteOrDelayUntilScriptLoaded(InitDBAlerts, "sp.js"));
...
{	
	...
	//	auditListQuery.set_viewXml('<View><Query><Where><Or><IsNull><FieldRef Name="StartDate"/></IsNull><Leq><FieldRef Name="StartDate"/><Value Type="DateTime" IncludeTimeValue="TRUE">' +  now  + '</Value></Leq></Or></Where></Query></View>');
		auditListQuery.set_viewXml('<View><Query><Where><And><Or><IsNull><FieldRef Name="StartDate"/></IsNull><Leq><FieldRef Name="StartDate"/><Value Type="DateTime" IncludeTimeValue="TRUE">' +  now  + '</Value></Leq></Or><Or><IsNull><FieldRef Name="EndDate"/></IsNull><Geq><FieldRef Name="EndDate"/><Value Type="DateTime" IncludeTimeValue="TRUE">' +  now  + '</Value></Geq></Or></And></Where></Query></View>');
