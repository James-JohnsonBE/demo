	...
	<div id="tabs-0">
		...
		<div id="divStatusReportRespones">
			<table id="tblStatusReportResponses" class="tablesorter report">
				...
				<tfoot class="footer">
					<tr>
						<th colspan="6">Displaying <span id="spanResponsesDisplayedTotal" style="color:green">0</span> out of <span id="spanResponsesTotal" style="color:green">0</span> Responses</th>
					</tr>
				</tfoot>
			</table>
		</div>
	...
	<div id="tabs-1">			
			...
			<fieldset>
				...
				<table id="tblResponseInfo" class="tablesorter">
					<tbody>
						...
						<tr>
							<td>Subject</td>
							<td><span id="requestInfoSubject"></span></td>
						</tr>
						<tr>
							<td>Due Date</td>
		...
		<div class="divSubmit" style="display:none">
			<fieldset style="border-color:GreenYellow"><legend style="font-weight:bold; font-size:11pt;">SUBMIT RESPONSE</legend>
				<div style="padding-top:15px; padding-bottom:15px;"><span class='ui-icon ui-icon-disk'></span><a class="btnSubmitPackage" href="javascript:void(0)" title="Click to Submit the Response Package">Submit this Response Package</a></div>
			</fieldset>
		</div>
		<div id="divResponseDocs" style="display:none">
			...
			<fieldset><legend>Response Documents</legend>
				...
				<table id="tblResponseDocs" class="tablesorter report">
					...
					<tfoot>
						<tr valign="top">
							<th colspan="7" nowrap="nowrap">Total: <span id="tblResponseDocsTotal">0</span></th>
						</tr>
					</tfoot>
				</table>
				
				<div class="divUpload two"></div>
...
<script type="text/javascript" src="../SiteAssets/js/Audit_Page_AO.js"></script>
