...
{			
	...
	{
		/*if( !m_bLoadedRequestDocsAndCoverSheets )
		{
			//dont go into this if the coversheets havent been loaded because they break the permissions further down
			SP.UI.Notify.addNotification("Please wait the page is still loading...", false);
			return;
		}*/
