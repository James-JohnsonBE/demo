...
<div id="tabs" style="display:none; margin-top:20px;">
	<ul>
		...
		<li style="display:none"><a href="#tabs-3">Response Permissions</a></li>
		<li style="display:none"><a href="#tabs-4">Response Folder Permissions</a></li>
	</ul>
	
	<div id="tabs-0">
		<fieldset style="width:300px"><legend>Actions</legend>
			...
			<div><a id="linkGetVerification" title="Select Action Office(s) to Obtain Verification of User" disabled="disabled" href="javascript:void(0)"><span class="ui-icon ui-icon-gear"></span>Obtain Action Office Verification</a></div>
			<div><a id="linkEmailHistory" title="View Email History" href="javascript:void(0)"><span class="ui-icon ui-icon-search"></span>View Email History</a></div>
			<div><a id="linkUploadPermissions" title="Import Users to SharePoint Groups" href="javascript:void(0)"><span class="ui-icon ui-icon-person"></span>Import Users into Groups</a></div>
			<div><a id="linkViewAO" title="View Action Offices" href="javascript:void(0)"><span class="ui-icon ui-icon-search"></span>View Action Office Details</a></div>
			<div><a title="Add Action Office" href="#" id="linkAddAO" title="Add Action Office"><span class="ui-icon ui-icon-circle-plus"></span>Add Action Office</a></div>
		</fieldset>
		<div id="divTblOutput" style="width:100%; padding-bottom:10px;">
			<table id="table_Groups" class="tablesorter">
				<thead>
					<tr><th class="removeOnExport"><input class="cbAOAll" id="cbAOAll" type="checkbox" style="cursor: pointer;"> Check All?</th><th>Action Office</th><th>SharePoint Group Name</th><th>Users<a id="linkViewExportFriendly" style="float:right" title="View Export Friendly" href="javascript:void(0)"><span class="ui-icon ui-icon-gear"></span>View Export Friendly</a></th></tr>
				</thead>
				<tbody id="fbody"></tbody>
				<tfoot>
					<tr><th colspan = "4" style="text-align:left;white-space:nowrap">Total: <span id="spanTotalAOS">0</span></th></tr>
				</tfoot>
			</table>
		</div>
	</div>
	...
	<div id="tabs-1">
		<div id="divTblSiteUsersOutput" style="width:100%; padding-bottom:10px;">
			<table id="table_SiteGroups" class="tablesorter">
				<thead>
					<tr><th>SharePoint Group Name</th><th>Users</th></tr>
				</thead>
	...
	<div id="tabs-2">	
		<table id="tblRequestsPermissions" class="tablesorter">
			<thead>				
				<tr valign="top">
					<th class="sorter-false" nowrap="nowrap"><select id="ddlRequestID"></select></th>
			...
			<tfoot>
				<tr valign="top">
					<th nowrap="nowrap" colspan="5">Total: <span id="tblRequestsPermsTotal">0</span></th>
				</tr>
			</tfoot>
		</table>
	</div>
		...
		<table id="tblResponsePermissions" class="tablesorter">
			<thead>				
				...
				<tr valign="top">
					...
					<th class="sorter-false" nowrap="nowrap">Status</th>
					<th class="sorter-false" nowrap="nowrap">Request Action Offices(s)</th>
					...
					<th class="sorter-false" nowrap="nowrap">Response Special Perms?</th>
					<th class="sorter-false" nowrap="nowrap">Permissions</th>
				</tr>
			</thead>
			<tbody></tbody>
			<tfoot>
				<tr valign="top">
					<th nowrap="nowrap" colspan="8">Total: <span id="tblResponsePermsTotal">0</span></th>
				</tr>
			</tfoot>
		</table>
	</div>
	...
	<div id="tabs-4" style="display:none">	
		<table id="tblResponseFolderPermissions" class="tablesorter">
			<thead>				
				<tr valign="top">
					<th class="sorter-false" nowrap="nowrap"></th>
					<th class="sorter-false" nowrap="nowrap"><select id="ddlResponseFolderResponseID"></select></th>
					<th class="sorter-false" nowrap="nowrap"></th>
					<th class="sorter-false" nowrap="nowrap"></th>
					<th class="sorter-false" nowrap="nowrap"></th>
					<th class="sorter-false" nowrap="nowrap"></th>
			...
			<tfoot>
				<tr valign="top">
					<th nowrap="nowrap" colspan="10">Total: <span id="tblResponseFolderPermsTotal">0</span></th>
				</tr>
			</tfoot>
		</table>
	</div>
...
<script type="text/javascript" src="../SiteAssets/js/Audit_Page_Permissions.js"></script>
