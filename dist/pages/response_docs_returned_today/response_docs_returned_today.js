  ...
  Audit2.ResponseDocsReport.NewReportPage = function() {
    ...
    function LoadInfo() {
      ...
      responseQuery.set_viewXml(
        '<View><Query><OrderBy><FieldRef Name="Title"/></OrderBy><Where><Eq><FieldRef Name="ResStatus"/><Value Type="Text">5-Returned to GFS</Value></Where></Eq></Query></View>'
      );
      ...
      var camlq = '<View Scope="RecursiveAll"><Query><Where><And><Eq><FieldRef Name="DocumentStatus"/><Value Type="Text">Rejected</Value></Eq><Eq><FieldRef Name="FSObjType"/><Value Type="int">0</Value></Eq></And></Where></Query></View>';
      responseDocsQuery.set_viewXml(camlq);
...
//# sourceMappingURL=response_docs_returned_today.js.map
